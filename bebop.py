...
lcrc_cpol_path = '/lcrc/group/earthscience/radar/CPOL_level_1b/GRIDDED/GRID_70km_1000m/2015/'
lcrc_cpol_20161210_path = '/lcrc/group/earthscience/radar/CPOL_level_1b/GRIDDED/GRID_70km_1000m/2016/20161210/'

out_dir = '/home/jporcaro/cpol_analysis/cpol_out_allyears1/'
out_dir_1month = '/home/jporcaro/cpol_analysis/cpol_out_1month/'              
...
def get_col_stats(radar_file_path):    
    ...
    twenty_col = [(-11.75, -11.50, 130.50, 130.75), # A
                  ...
                  (-11.75, -11.50, 130.00, 131.25), # C
                  (-11.75, -11.50, 130.25, 131.50), # D
                  ...
                  (-12.75, -12.50, 131.25, 131.50), # S
                  (-12.75, -12.50, 131.50, 131.75), # T
                 ]
    ...
    fn_abs = os.path.join(out_dir, fn)
...
def main():
    ...
    file_list = glob.glob(cpol_allyears_path + '/**/*.nc', recursive=True)
